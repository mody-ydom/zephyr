	...
	if ( ! class_exists( 'ACF_To_REST_API_Donation' ) ) {
		...
		class ACF_To_REST_API_Donation {
			...
			public static function admin_enqueue_scripts() {
				wp_enqueue_script( 'acf_to_rest_api_donation',
				                   plugins_url( 'assets/js/acf-to-rest-api-donation.js', dirname( __FILE__ ) . '/../../../../' ),
				                   array( 'jquery' ),
				                   ACF_To_REST_API::VERSION,
				                   true );
				wp_localize_script( 'acf_to_rest_api_donation',
				                    'acf_to_rest_api_donation',
				                    array(
