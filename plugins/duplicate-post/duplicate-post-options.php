<?php
	...
	function duplicate_post_menu() {
		$page_hook = add_options_page( /* translators: %s: Yoast */ sprintf( __( '%s Duplicate Post settings', 'duplicate-post' ), 'Yoast' ),
	...
	function duplicate_post_options() {
		...
		if ( current_user_can( 'promote_users' ) && ( isset( $_GET['settings-updated'] ) && $_GET['settings-updated'] == true ) ) {
			...
			foreach ( $roles as $name => $display_name ) {
				...
				} /* If the role has the capability and it wasn't selected, remove it. */ elseif ( $role->has_cap( 'copy_posts' ) && ! in_array( $name, $dp_roles ) ) {
              ...
              <tr>
                ...
                <td>
                  <fieldset>
                    ...
                    <span id="duplicate-post-copyattachments-description">(<?php esc_html_e( 'you probably want this unchecked, unless you have very special requirements',
					                                                                         'duplicate-post' ); ?>)</span><br/>
                    <input type="checkbox"
                ...
                <td>
                  <fieldset>
                    ...
                    <p>
						...
						<?php esc_html_e( 'Whether the links are displayed for custom post types registered by themes or plugins depends on their use of standard WordPress UI elements.',
						                  'duplicate-post' ); ?>
                    </p>
                  </fieldset>
                </td>
            ...
            <table class="form-table" role="presentation">
              <tr>
                ...
                <td>
                  <fieldset>
                    ...
                    <span id="duplicate-post-show-adminbar-description">(<?php esc_html_e( 'now works on Edit screen too - check this option to use with Gutenberg enabled',
					                                                                       'duplicate-post' ); ?>)</span><br/>
					  <?php
                  ...
                  <p>
                    ...
                    <br/>
					  <?php
						  printf( /* translators: 1: Code start tag, 2: Code closing tag, 3: Link start tag to the template tag documentation, 4: Link closing tag. */ esc_html__( 'You can also use the template tag %1$sduplicate_post_clone_post_link( $link, $before, $after, $id )%2$s. %3$sMore info on the template tag%4$s.',
						                                                                                                                                                           'duplicate-post' ),
						                                                                                                                                               '<code>',
						                                                                                                                                               '</code>',
						                                                                                                                                               '<a href="' .
						                                                                                                                                               esc_url( 'https://developer.yoast.com/duplicate-post/functions-template-tags#duplicate_post_clone_post_link' ) .
						                                                                                                                                               '">',
						                                                                                                                                               '</a>' );
					  ?>
                  </p>
              ...
              <tr>
                ...
                <td>
                  ...
                  <p id="duplicate-post-show-original-meta-box-description">(<?php esc_html_e( "you'll also be able to delete the reference to the original item with a checkbox",
				                                                                               'duplicate-post' ); ?>)</p><br/>
                  <input
                    type="checkbox"
                  ...
                  <p id="duplicate-post-show-original-column-description">(<?php esc_html_e( "you'll also be able to delete the reference to the original item with a checkbox in Quick Edit",
				                                                                             'duplicate-post' ); ?>)</p><br/>
                  <input
                    type="checkbox"
