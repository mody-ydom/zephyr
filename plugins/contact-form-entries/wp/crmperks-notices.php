	...
	if( ! class_exists( 'vx_crmperks_notice_cf_form' ) ):
		class vx_crmperks_notice_cf_form{
			...
			public function install_forms_notice(){
				...
				if( empty( $show ) ){
					...
					if( ! class_exists( 'cfx_form' ) ){
						...
						$msg = sprintf(
							__( '%sCRM Perks Forms Plugin%s is a free lightweight contact form builder and designer with floating buttons and popups.', 'contact-form-entries' ),
			...
			public function admin_footer( $text ){
				if( isset( $_GET['page'] ) && $_GET['page'] == vxcf_form::$id ){
					$text = sprintf(
						__( 'if you enjoy using %sContact Form Entries Plugin%s, please %s leave us a %s rating%s. A %shuge%s thank you in advance.', 'contact-form-entries' ),
						'<b>',
						'</b>',
				...
				if( ! empty( $install_time ) && is_array( $install_time ) && ! empty( $install_time['time'] ) && empty( $install_time['review_closed'] ) ){
					...
					if( $time > $time_i ){
                      ...
                      <div class="notice notice-info is-dismissible vxcf-review-notice" style="margin: 14px 0 -4px 0">
                        <p><?php echo sprintf(
								__(
									'You\'ve been using Contact Form Entries Plugin for some time now; we hope you love it!.%s If you do, please %s leave us a %s rating on WordPress.org%s to help us spread the word and boost our motivation.',
                ...
                <div class="vx_row  clear">
                  <div class="vx_row_inner">
                    ...
                    <div class="col-2">
                      ...
                      <p>Verify lead's phone number and get detailed information about phone number using phone lookup apis, We support many good phone lookup apis like everyoneapi , whitepages api ,
                        twilio api and numverify api.</p>
                      <p><a href="<?php echo $plugin_url ?>" target="_blank" class="button-primary button">Go Premium</a></p>
                    </div>
			...
			public function free_plugins_notice(){
              ...
              <div class="updated below-h2" style="border: 1px solid  #1192C1; border-left-width: 6px; padding: 5px 12px;">
                ...
                <p><b><a href="https://wordpress.org/plugins/crm-perks-forms/" target="_blank">CRM Perks Forms</a></b> is lightweight and highly optimized contact form builder with Poups and floating
                  buttons.</p>
                <p><b><a href="https://wordpress.org/plugins/support-x/" target="_blank">Support X - Wordpress Helpdesk</a></b> Shows user tickets from HelpScout, ZenDesk, FreshDesk, Desk.com and
                  Teamwork in wordpress. Users can create new tickets and reply to old tickets from wordpress.</p>
                <p><b><a href="https://wordpress.org/plugins/woo-salesforce-plugin-crm-perks/" target="_blank">WooCommerce Salesforce Plugin</a></b> allows you to quickly integrate WooCommerce Orders
                  with Salesforce CRM.</p>
