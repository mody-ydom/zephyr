  ...
  <form action="" method="post">
    ...
    <table class="form-table">
                ...
                <td>
					<?php
						...
						foreach( $forms_arr as $k => $v ){
							...
							?>
                          <p><label for="vx_form_<?php echo $k ?>"><input type="checkbox" name="meta[disable_track][<?php echo $k ?>]" value="yes" <?php if( vxcf_form::post( $k, $saved_forms ) ==
						                                                                                                                                     "yes" ){
      ...
      <tr>
        ...
        <td>
          <label for="vx_cookies"><input type="checkbox" name="meta[cookies]" value="yes" <?php if( vxcf_form::post( 'cookies', $meta ) == "yes" ){
				  echo 'checked="checked"';
      ...
      <tr>
        ...
        <td>
          <label for="vx_ip"><input type="checkbox" name="meta[ip]" value="yes" <?php if( vxcf_form::post( 'ip', $meta ) == "yes" ){
				  echo 'checked="checked"';
      ...
      <tr>
        ...
        <td>
          <label for="vx_plugin_data"><input type="checkbox" name="meta[plugin_data]" value="yes" <?php if( vxcf_form::post( 'plugin_data', $meta ) == "yes" ){
				  echo 'checked="checked"';
	  ...
	  ?>
    <p class="submit">
      <button type="submit" value="save" class="button-primary" title="<?php _e( 'Save Changes', 'contact-form-entries' ); ?>" name="save"><?php _e(
			  'Save Changes',
