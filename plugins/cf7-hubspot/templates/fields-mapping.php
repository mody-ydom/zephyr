                    ...
                    <div class="vx_margin">
							...
							if( isset( $v['name_c'] ) ){
                              ...
                              <div class="entry_row">
                                ...
                                <div class="entry_col2">
                                  <input type="text" name="meta[map][<?php echo $k ?>][name_c]" value="<?php echo $v['name_c'] ?>"
                                         placeholder="<?php _e( 'Field API Name', 'contact-form-hubspot-crm' ) ?>" class="vx_input_100">
                                </div>
                                <div class="crm_clear"></div>
                              </div>
								<?php
                      ...
                      <div class="entry_row entry_row2">
                        <div class="entry_col1 vx_label">
                          <label for="vx_field_<?php echo $k ?>" style="<?php if( $this->post2( $k, 'type', $map ) != '' ){
							  echo 'display:none';
						  } ?>" class="vxc_fields vxc_field_"><?php _e( 'Select Field', 'contact-form-hubspot-crm' ) ?></label>
                          
                          <label for="vx_value_<?php echo $k ?>" style="<?php if( $this->post2( $k, 'type', $map ) != 'value' ){
							  echo 'display:none';
						  } ?>" class="vxc_fields vxc_field_value"> <?php _e( 'Custom Value', 'contact-form-hubspot-crm' ) ?></label>
                        </div>
                        <div class="entry_col2">
                          <div class="vxc_fields vxc_field_value" style="<?php if( $this->post2( $k, 'type', $map ) != 'value' ){
							  echo 'display:none';
						  } ?>">
                            <input type="text" name='meta[map][<?php echo $k ?>][value]' id="vx_value_<?php echo $k ?>" value='<?php echo $this->post2( $k, 'value', $map ) ?>'
                                   placeholder='<?php _e( "Custom Value", 'contact-form-hubspot-crm' ) ?>' class='vx_input_100 vxc_field_input'>
                            <div class="howto"><?php echo sprintf(
									__( 'You can add a form field %s in custom value from following form fields', 'contact-form-hubspot-crm' ),
									'<code>{field_id}</code>' ) ?></div>
                          </div>
		  ...
		  <?php
			  if( $api_type == "web" ){ ?>
                <div class="vx_fields_footer">
                  <div class="vx_row">
                    <div class="vx_col1"> &nbsp;</div>
                    <div class="vx_col2">
                      <button type="button" class="button button-default" id="xv_add_custom_field"><i class=" fa fa-plus-circle"></i> <?php _e( 'Add Custom Field', 'contact-form-hubspot-crm' ) ?>
                      </button>
                    </div>
                    <div class="clear"></div>
                  </div>
			  ...
			  <?php }else{ ?>
                <div class="crm_panel crm_panel_100">
                  <div class="crm_panel_head2">
                    ...
                    <div class="crm_btn_div"><i class="fa crm_toggle_btn vx_btn_inner fa-minus" style="display: none;" title="<?php _e( 'Expand / Collapse', 'contact-form-hubspot-crm' ); ?>"></i>
                    </div>
                    <div class="crm_clear"></div>
                  </div>
                  <div class="more_options crm_panel_content" style="display: block;">
                    ...
                    <div class="vx_margin">
                      <div style="display: table">
                        ...
                        <div style="display: table-cell;">
                          <button type="button" class="button button-default" style="vertical-align: middle;" id="xv_add_custom_field"><i class="fa fa-plus-circle"></i> <?php _e(
								  'Add Field',
...
<div class="vx_div">
  ...
  <?php _e( 'Disable Automatic Export', 'contact-form-hubspot-crm' ); ?>
    ...
    <div class="vx_row">
      ...
      <div class="vx_col2">
        <div>
          <input type="checkbox" style="margin-top: 0px;" id="crm_optin" class="crm_toggle_check" name="meta[optin_enabled]" value="1" <?php echo ! empty( $meta["optin_enabled"] ) ?
			  "checked='checked'" : "" ?>/>
          <label for="crm_optin">
                    ...
                    <div class="vx_filter_or" data-id="<?php echo $filter_k ?>">
                      ...
                      <div class="vx_filter_div">
								  ...
								  foreach( $filter_v as $s_k => $s_v ){
                                    ...
                                    <div class="vx_filter_and">
                                      ...
                                      <div class="vx_filter_field vx_filter_field3">
                                        <input type="text" class="vxc_filter_text" placeholder="<?php _e( 'Value', 'contact-form-hubspot-crm' ) ?>" value="<?php echo $this->post( 'value', $s_v ) ?>"
                                               name="meta[filters][<?php echo $filter_k ?>][<?php echo $s_k ?>][value]">
                                      </div>
										<?php if( $sno_i > 1 ){ ?>
                        ...
                        <div class="vx_btn_div">
                          <button class="button button-default button-small vx_add_and" title="<?php _e( 'Add AND Filter', 'contact-form-hubspot-crm' ); ?>"><i
                              class="vx_icons-s vx_trash_and fa fa-hand-o-right"></i>
          ...
          <div style="display: none;" id="vx_filter_temp">
            <div class="vx_filter_or">
              ...
              <div class="vx_filter_div">
                ...
                <div class="vx_btn_div">
                  <button class="button button-default button-small vx_add_and" title="<?php _e( 'Add AND Filter', 'contact-form-hubspot-crm' ); ?>"><i
                      class="vx_icons vx_trash_and  fa fa-hand-o-right"></i>
					  <?php _e( 'Add AND Filter', 'contact-form-hubspot-crm' ) ?>
                  </button>
                  <a href="#" class="vx_trash_or">
					  <?php _e( 'Trash', 'contact-form-hubspot-crm' ) ?>
	  ...
	  <?php
		  if( $module != 'Task' ){
			  ...
			  if( ! empty( $settings['notes'] ) ){
                ...
                <div class="vx_row">
                  <div class="vx_col1">
                    <label for="vx_notes"><?php _e( 'Entry Notes ', 'contact-form-hubspot-crm' );
							$this->tooltip( 'vx_entry_notes' ); ?></label>
                  </div>
                  <div class="vx_col2">
                    <input type="checkbox" style="margin-top: 0px;" id="vx_notes" class="crm_toggle_check" name="meta[entry_notes]" value="1" <?php echo ! empty( $meta['entry_notes'] ) ?
        ...
        <div class="vx_group">
          <div class="vx_row">
            ...
            <div class="vx_col2">
              ...
              <div class="description" style="float: none; width: 90%"><?php _e(
					  'If you want to update a pre-existing object, select what should be used as a unique identifier ("Primary Key"). For example, this may be an email address, lead ID, or address. When a new entry comes in with the same "Primary Key" you select, a new object will not be created, instead the pre-existing object will be updated.',
					  '%dd%' ); ?></div>
            </div>
            <div class="clear"></div>
          </div>
          <div class="vx_row">
            ...
            <div class="vx_col2">
              <input type="checkbox" style="margin-top: 0px;" id="vx_update" class="crm_toggle_check" name="meta[update]" value="1" <?php echo ! empty( $meta['update'] ) ? 'checked="checked"' : '' ?>
                     autocomplete="off"/>
            ...
            <div class="vx_row">
              <div class="vx_col1">
                <label for="crm_note_fields">
					<?php _e( 'Note Fields ', 'contact-form-hubspot-crm' );
						$this->tooltip( "vx_note_fields" ) ?>
                </label>
              </div>
            ...
            <div class="vx_row">
              <div class="vx_col1">
                <label for="crm_disable_note">
					<?php _e( 'Disable Note ', 'contact-form-hubspot-crm' );
						$this->tooltip( "vx_disable_note" ) ?>
                </label>
              </div>
              <div class="vx_col2">
                
                <input type="checkbox" style="margin-top: 0px;" id="crm_disable_note" class="crm_toggle_check" name="meta[disable_entry_note]"
                       value="1" <?php echo ! empty( $meta['disable_entry_note'] ) ? "checked='checked'" : "" ?>/>
                <label for="crm_disable_note">
	...
	if( in_array( $module, array( 'Task', 'Contact', 'Company' ) ) ){
      ...
      <div class="vx_div vx_refresh_panel ">
        ...
        <div class="vx_group ">
          <div class="vx_row">
            <div class="vx_col1">
              <label for="crm_owner"><?php _e( "Assign Owner ", 'contact-form-hubspot-crm' );
					  $this->tooltip( 'vx_owner_check' ); ?></label>
            </div>
            <div class="vx_col2">
              <input type="checkbox" style="margin-top: 0px;" id="crm_owner" class="crm_toggle_check <?php if( empty( $users ) ){
				  echo 'vx_refresh_btn';
			  } ?>" name="meta[owner]" value="1" <?php echo ! empty( $meta["owner"] ) ? "checked='checked'" : "" ?> autocomplete="off"/>
          ...
          <div id="crm_owner_div" style="<?php echo empty( $meta["owner"] ) ? "display:none" : "" ?>">
            <div class="vx_row">
              <div class="vx_col1">
                <label><?php _e( 'Users List ', 'contact-form-hubspot-crm' );
						$this->tooltip( 'vx_owners' ); ?></label>
              </div>
              <div class="vx_col2">
            ...
            <div class="vx_row">
              <div class="vx_col1">
                <label for="crm_sel_user"><?php _e( 'Select User ', 'contact-form-hubspot-crm' );
						$this->tooltip( 'vx_sel_owner' ); ?></label>
              </div>
              <div class="vx_col2">
      ...
      <div class="vx_div vx_refresh_panel ">
        ...
        <div class="vx_group ">
          <div class="vx_row">
            ...
            <div class="vx_col2">
              <input type="checkbox" style="margin-top: 0px;" id="crm_flow" class="crm_toggle_check <?php if( empty( $pipes ) ){
				  echo 'vx_refresh_btn';
			  } ?>" name="meta[add_pipe]" value="1" <?php echo ! empty( $meta["add_pipe"] ) ? "checked='checked'" : "" ?> autocomplete="off"/>
      ...
      <div class="vx_div vx_refresh_panel ">
        ...
        <div class="vx_group ">
          <div class="vx_row">
            ...
            <div class="vx_col2">
              <input type="checkbox" style="margin-top: 0px;" id="crm_flow1" class="crm_toggle_check <?php if( empty( $pipes ) ){
				  echo 'vx_refresh_btn';
			  } ?>" name="meta[add_sales_pipe]" value="1" <?php echo ! empty( $meta["add_sales_pipe"] ) ? "checked='checked'" : "" ?> autocomplete="off"/>
              <label for="crm_flow"><?php _e( "Enable", 'contact-form-hubspot-crm' ); ?></label>
            </div>
            <div class="clear"></div>
          </div>
...
<div class="button-controls submit" style="padding-left: 5px;">
  ...
  <button type="submit" title="<?php _e( 'Save Feed', 'contact-form-hubspot-crm' ); ?>" name="<?php echo $this->id ?>_submit" class="button button-primary button-hero"><i
      class="vx_icons vx vx-arrow-50"></i> <?php echo empty( $fid ) ? __( "Save Feed", 'contact-form-hubspot-crm' ) : __( "Update Feed", 'contact-form-hubspot-crm' ); ?> </button>
</div>
