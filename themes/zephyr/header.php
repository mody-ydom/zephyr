...
<body data-scroll-speed-desktop="<?=$website_scroll_speed['desktop']?>"
  ...
  <div class="smooth-scroller" smooth-scroll-container>
    <main data-header-class="<?=is_singular( 'post' ) || is_404() || is_tag() || is_category() || is_author() || is_search() || is_page_template( 'archive.php' ) ? 'black' : $page_header_type?>"
          data-barba="container" data-barba-namespace="<?=is_singular( 'post' ) || is_page_template( 'archive.php' ) ? 'blog' : 'home'?>">
      <!-- overlay dark menu -->
