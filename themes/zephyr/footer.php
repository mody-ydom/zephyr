  ...
  <div class="container">
    <div class="footer-content">
      ...
      <div class="logo-and-copy">
        <a href="<?=get_home_url();?>">
          <img src="<?=$footer_logo['url'];?>" alt="logo.png">
        </a>
        <div class="paragraph">
			<?=$copywrite_text;?>
        </div>
      ...
      <div class="links">
        <div class="title-and-link  newsletter">
          <h3 class="headline-7"><?=$subscribe_to_newsletter;?></h3>
		  ...
		  <?php while( have_rows( 'footer_links', 'options' ) ):the_row(); ?>
			  <?php if( get_row_layout() == 'footer_links_block' ):
				  ...
				  ?>
              <div class="title-and-link  <?=strtolower( $block_title );?>">
				  <?php if( $block_title == 'social' ):
                    ...
                    <div class="link desktop-only">
                      <a class="paragraph" href="<?=$facebook_url;?>"><span data-hover="Facebook">Facebook</span></a>
                      <a class="paragraph" href="<?=$linkedin_url;?>"><span data-hover="Linkedin">Linkedin</span></a>
                      <a class="paragraph" href="<?=$twitter_url;?>"><span data-hover="Twitter">Twitter</span></a>
                    </div>
				  <?php else: ?>
                    <h3 class="headline-7"><?=$block_title;?></h3>
                    <div class="link">
