...
<div class="container">
  <div class="content">
    <?php if ($small_title) { ?><h6 class="iv-st-from-bottom headline-6 center"><?=$small_title;?></h6><?php } ?>
    <?php if ($big_title) { ?> <h1 class="iv-st-from-bottom headline-1 center"><?=$big_title;?></h1><?php } ?>
    <?php if ($paragraph) { ?>
      <div class="iv-st-from-bottom paragraph center"><?=$paragraph;?> </div>
    <?php } ?>
    <?php if ($button['title']) { ?>
