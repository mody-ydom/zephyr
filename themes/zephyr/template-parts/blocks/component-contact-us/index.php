                        ...
                        <?php if ($email) { ?>
                            <div class="icon-and-info iv-st-from-bottom">
                                <svg class="desktop-only" width="20" height="14" viewBox="0 0 20 14" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M19.0001 1H1.1001V13.3057H19.0001V1Z" stroke="#252525" stroke -
                                          width="1.08"
                                ...
                                <div class="info">
                                    ...
                                    <a class="paragraph-1 word-up small-fz"
                        ...
                        <?php if ($address) { ?>
                            <div class="icon-and-info iv-st-from-bottom location">
                                ...
                                <div class="info">
                                    ...
                                    <p class="paragraph-1 word-up small-fz"> 1 - 3 French Place, London, E1 6JB United
                                        Kingdom </p>
                                </div>
                            </div>
                        <?php } ?>
                        <?php if ($phone) { ?>
                            <div class="icon-and-info iv-st-from-bottom">
                                ...
                                <div class="info">
                                    ...
                                    <a class="paragraph-1 word-up small-fz" href="tel:+44 07887 552949"> +44 07887
                                        552949 </a>
                                </div>
                            </div>
                        <?php } ?>
