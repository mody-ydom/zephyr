...
function my_plugin_block_categories($categories)
{
    return array_merge($categories,
        array(
            ...
            array(
                'slug' => 'zephyr-careers',
                'title' => __('Zephyr Careers', 'zephyr'),
                'icon' => 'welcome-learn-more',
            ),
            array(
                'slug' => 'zephyr-success-stories',
                'title' => __('Zephyr Success Stories', 'zephyr'),
                'icon' => 'welcome-learn-more',
            ),
        ));
}
...
function register_acf_block_types()
{
    ...
    acf_register_block_type(array(
        ...
        'render_template' => 'template-parts/blocks/component-customer-hero/index.php',
        'enqueue_style' => $developing ? '' : get_template_directory_uri() . '/template-parts/blocks/component-customer-hero/style.css',
        'category' => 'zephyr-success-stories',
